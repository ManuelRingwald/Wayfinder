    ...
    socket.addEventListener('message', (event) => {
      try {
        ...
        if (msg.feed_status) {
          ...
          store.setFeedHealth(msg.feed_status.feed_id, msg.feed_status.color, msg.feed_status.degraded_reason, msg.feed_status.sensors, msg.feed_status.sdps_degraded)
