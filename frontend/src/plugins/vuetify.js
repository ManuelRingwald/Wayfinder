...
// change BOTH together (near-black palette, ADR 0015 Nachtrag-2: the Claude
// Design export is the authoritative template, superseding the navy Nachtrag).
const asdDarkTheme = {
  dark: true,
  colors: {
    // Background hierarchy (darkest → lightest surface level), near-black
    background: '#070b12',
    surface: '#0e1622',
