...
| `WAYFINDER_MAP_THEME` | `dark` | enum | `dark` (CARTO Dark, kein API-Key), `bkg` (**amtliche basemap.de-Vektorkarte**, hell, ADR 0026), `bkg-dark` (**Radar-Scope-Dunkelvariante** derselben amtlichen Daten, server-seitig transformiert, H2) oder `osm` (OpenStreetMap-Raster, deprecated) |
