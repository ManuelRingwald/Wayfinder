...
**➡️ Nächster Schritt:** **WF2-21 — Subscription-Modell & scoped Fan-out**
(`broadcast()` von all-to-all auf **prädikat-gefiltert**: `feed ∈ subscriptions ∧
AOI ∧ FL-Band ∧ Kategorie`, getrieben durch die Tenant-Identity je WS-Client) 🔒
**S4–S5 · Opus 4.8 / Fable 5**, nach Ankündigung & „Go". Danach WF2-22
...
| **WF2-21** 🔒 | Subscription-Modell & scoped Fan-out (`broadcast()` → Prädikat feed∩AOI∩FL∩Kat) | **S4–S5 · Opus 4.8 / Fable 5** | WF2-12, WF2-20 | ➡️ **nächster** |
